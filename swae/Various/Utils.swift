...
/// Creates a SettingsSceneWidget with smart default position/size for the given widget type.
/// Shared between SceneSettingsView (Settings path) and InlineAddWidgetView (Quick-Add path).
func createDefaultSceneWidget(for widget: SettingsWidget) -> SettingsSceneWidget {
    ...
    // Center the widget in the preview by default
    sceneWidget.x = (100 - sceneWidget.width) / 2
    sceneWidget.y = (100 - sceneWidget.height) / 2
    return sceneWidget
}

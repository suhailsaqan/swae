...
enum ZapStreamCoreProtocol: String, Codable, CaseIterable {
    case rtmp = "rtmp"
    case srt = "srt"

    init(from decoder: Decoder) throws {
        self =
            try ZapStreamCoreProtocol(
...
enum ZapPlasmaColorPreset: String, Codable, CaseIterable {
    case orange = "orange"
    case blue = "blue"
    case purple = "purple"
    case green = "green"
    ...
    init(from decoder: Decoder) throws {
        self =
            try ZapPlasmaColorPreset(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .orange
    }

    var displayName: String {
        switch self {
        case .orange: return "Lightning Orange"
        case .blue: return "Electric Blue"
        case .purple: return "Nostr Purple"
        case .green: return "Matrix Green"
        case .pink: return "Neon Pink"
        case .white: return "Pure Energy"
        case .custom: return "Custom"
        }
    }

    var coolColor: SIMD3<Float> {
        switch self {
        case .orange: return SIMD3<Float>(1.0, 0.6, 0.1)
        case .blue: return SIMD3<Float>(0.2, 0.6, 1.0)
        case .purple: return SIMD3<Float>(0.6, 0.3, 1.0)
        case .green: return SIMD3<Float>(0.2, 1.0, 0.4)
        case .pink: return SIMD3<Float>(1.0, 0.3, 0.6)
        case .white: return SIMD3<Float>(0.9, 0.95, 1.0)
        case .custom: return SIMD3<Float>(1.0, 0.6, 0.1)
        }
    }

    var hotColor: SIMD3<Float> {
        switch self {
        case .orange: return SIMD3<Float>(1.0, 0.95, 0.85)
        case .blue: return SIMD3<Float>(0.8, 0.95, 1.0)
        case .purple: return SIMD3<Float>(0.9, 0.8, 1.0)
        case .green: return SIMD3<Float>(0.8, 1.0, 0.9)
        case .pink: return SIMD3<Float>(1.0, 0.85, 0.95)
        case .white: return SIMD3<Float>(1.0, 1.0, 1.0)
        case .custom: return SIMD3<Float>(1.0, 0.95, 0.85)
        }
    }
}
...
class SettingsStream: Codable, Identifiable, Equatable, ObservableObject, Named {
    ...
    // MARK: - Zap Stream Core Settings
    @Published var zapStreamCoreEnabled: Bool = false
    var zapStreamCoreBaseUrl: String = defaultZapStreamCoreBaseUrl
    @Published var zapStreamCoreStreamTitle: String = ""
    @Published var zapStreamCoreStreamDescription: String = ""
    @Published var zapStreamCoreIsPublic: Bool = true
    @Published var zapStreamCorePreferredProtocol: ZapStreamCoreProtocol = .rtmp
    @Published var zapStreamCoreAutoCreateStream: Bool = true
    var zapStreamCoreStreamKey: String = ""
    @Published var zapStreamCoreStreamImage: String = ""
    @Published var zapStreamCoreStreamTags: [String] = []
    @Published var zapStreamCoreContentWarning: String = ""
    @Published var zapStreamCoreGoal: String = ""
    
    // MARK: - Zap Plasma Effect Settings
    @Published var zapPlasmaEffectEnabled: Bool = true
    var zapPlasmaEffectIntensityMultiplier: Float = 1.0  // 0.5 - 2.0 range
    var zapPlasmaEffectMinimumAmount: Int64 = 100_000    // Minimum millisats to trigger effect
    var zapPlasmaEffectColorPreset: ZapPlasmaColorPreset = .orange
    ...
    enum CodingKeys: CodingKey {
        case name,
            ...
            multiStreaming,
            zapStreamCoreEnabled,
            zapStreamCoreBaseUrl,
            zapStreamCoreStreamTitle,
            zapStreamCoreStreamDescription,
            zapStreamCoreIsPublic,
            zapStreamCorePreferredProtocol,
            zapStreamCoreAutoCreateStream,
            zapStreamCoreStreamKey,
            zapStreamCoreStreamImage,
            zapStreamCoreStreamTags,
            zapStreamCoreContentWarning,
            zapStreamCoreGoal,
            zapPlasmaEffectEnabled,
            zapPlasmaEffectIntensityMultiplier,
            zapPlasmaEffectMinimumAmount,
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.zapStreamCoreEnabled, zapStreamCoreEnabled)
        try container.encode(.zapStreamCoreBaseUrl, zapStreamCoreBaseUrl)
        try container.encode(.zapStreamCoreStreamTitle, zapStreamCoreStreamTitle)
        try container.encode(.zapStreamCoreStreamDescription, zapStreamCoreStreamDescription)
        try container.encode(.zapStreamCoreIsPublic, zapStreamCoreIsPublic)
        try container.encode(.zapStreamCorePreferredProtocol, zapStreamCorePreferredProtocol)
        try container.encode(.zapStreamCoreAutoCreateStream, zapStreamCoreAutoCreateStream)
        try container.encode(.zapStreamCoreStreamKey, zapStreamCoreStreamKey)
        try container.encode(.zapStreamCoreStreamImage, zapStreamCoreStreamImage)
        try container.encode(.zapStreamCoreStreamTags, zapStreamCoreStreamTags)
        try container.encode(.zapStreamCoreContentWarning, zapStreamCoreContentWarning)
        try container.encode(.zapStreamCoreGoal, zapStreamCoreGoal)
        try container.encode(.zapPlasmaEffectEnabled, zapPlasmaEffectEnabled)
        try container.encode(.zapPlasmaEffectIntensityMultiplier, zapPlasmaEffectIntensityMultiplier)
        try container.encode(.zapPlasmaEffectMinimumAmount, zapPlasmaEffectMinimumAmount)
        try container.encode(.zapPlasmaEffectColorPreset, zapPlasmaEffectColorPreset)
    ...
    required init(from decoder: Decoder) throws {
        ...
        zapStreamCoreEnabled = container.decode(.zapStreamCoreEnabled, Bool.self, false)
        zapStreamCoreBaseUrl = container.decode(
            .zapStreamCoreBaseUrl, String.self, defaultZapStreamCoreBaseUrl)
        zapStreamCoreStreamTitle = container.decode(.zapStreamCoreStreamTitle, String.self, "")
        zapStreamCoreStreamDescription = container.decode(
            .zapStreamCoreStreamDescription, String.self, "")
        zapStreamCoreIsPublic = container.decode(.zapStreamCoreIsPublic, Bool.self, true)
        zapStreamCorePreferredProtocol = container.decode(
            .zapStreamCorePreferredProtocol, ZapStreamCoreProtocol.self, .rtmp)
        zapStreamCoreAutoCreateStream = container.decode(
            .zapStreamCoreAutoCreateStream, Bool.self, true)
        zapStreamCoreStreamKey = container.decode(.zapStreamCoreStreamKey, String.self, "")
        zapStreamCoreStreamImage = container.decode(.zapStreamCoreStreamImage, String.self, "")
        zapStreamCoreStreamTags = container.decode(.zapStreamCoreStreamTags, [String].self, [])
        zapStreamCoreContentWarning = container.decode(.zapStreamCoreContentWarning, String.self, "")
        zapStreamCoreGoal = container.decode(.zapStreamCoreGoal, String.self, "")
        zapPlasmaEffectEnabled = container.decode(.zapPlasmaEffectEnabled, Bool.self, true)
        zapPlasmaEffectIntensityMultiplier = container.decode(
            .zapPlasmaEffectIntensityMultiplier, Float.self, 1.0)
        zapPlasmaEffectMinimumAmount = container.decode(
            .zapPlasmaEffectMinimumAmount, Int64.self, 100_000)
        zapPlasmaEffectColorPreset = container.decode(
            .zapPlasmaEffectColorPreset, ZapPlasmaColorPreset.self, .orange)
        zapPlasmaEffectCustomColorHex = container.decode(
            .zapPlasmaEffectCustomColorHex, String.self, "#FF9900")
        zapPlasmaEffectSoundEnabled = container.decode(
    ...
    func clone() -> SettingsStream {
        ...
        new.zapStreamCoreEnabled = zapStreamCoreEnabled
        new.zapStreamCoreBaseUrl = zapStreamCoreBaseUrl
        new.zapStreamCoreStreamTitle = zapStreamCoreStreamTitle
        new.zapStreamCoreStreamDescription = zapStreamCoreStreamDescription
        new.zapStreamCoreIsPublic = zapStreamCoreIsPublic
        new.zapStreamCorePreferredProtocol = zapStreamCorePreferredProtocol
        new.zapStreamCoreAutoCreateStream = zapStreamCoreAutoCreateStream
        new.zapStreamCoreStreamKey = zapStreamCoreStreamKey
        new.zapStreamCoreStreamImage = zapStreamCoreStreamImage
        new.zapStreamCoreStreamTags = zapStreamCoreStreamTags
        new.zapStreamCoreContentWarning = zapStreamCoreContentWarning
        new.zapStreamCoreGoal = zapStreamCoreGoal
        new.zapPlasmaEffectEnabled = zapPlasmaEffectEnabled
        new.zapPlasmaEffectIntensityMultiplier = zapPlasmaEffectIntensityMultiplier
        new.zapPlasmaEffectMinimumAmount = zapPlasmaEffectMinimumAmount
        new.zapPlasmaEffectColorPreset = zapPlasmaEffectColorPreset
...
enum SettingsWidgetType: String, Codable, CaseIterable {
    ...
    case nostrChat = "Nostr chat"
    case collabVideo = "Collab video"
    ...
    func toString() -> String {
        ...
        case .nostrChat:
            return String(localized: "Nostr chat")
        case .collabVideo:
            return String(localized: "Collab video")
        }
    }
}

let widgetTypes = SettingsWidgetType.allCases.filter { $0 != .videoEffect && $0 != .nostrChat && $0 != .collabVideo }
...
// MARK: - Nostr Chat Widget Settings

enum NostrChatUsernameStyle: String, Codable, CaseIterable {
    case coloredFromPubkey = "Colored from pubkey"
    case singleColor = "Single color"
    case hidden = "Hidden"

    init(from decoder: Decoder) throws {
        self = try NostrChatUsernameStyle(
    ...
    func toString() -> String {
        ...
        case .coloredFromPubkey:
            return String(localized: "Colored from pubkey")
        case .singleColor:
            return String(localized: "Single color")
        case .hidden:
...
enum NostrChatScrollDirection: String, Codable, CaseIterable {
    case bottomToTop = "Bottom to top"
    case topToBottom = "Top to bottom"

    init(from decoder: Decoder) throws {
        self = try NostrChatScrollDirection(
            rawValue: decoder.singleValueContainer().decode(RawValue.self)
        ) ?? .bottomToTop
    }
    ...
    func toString() -> String {
        switch self {
        case .bottomToTop:
            return String(localized: "Bottom to top")
        case .topToBottom:
            return String(localized: "Top to bottom")
        }
    }
}

class SettingsWidgetNostrChat: Codable, ObservableObject {
    // Background
    @Published var backgroundColor: RgbColor = .init(red: 0, green: 0, blue: 0, opacity: 0.0)
    @Published var cornerRadius: Float = 8

    // Message text
    @Published var messageColor: RgbColor = .init(red: 255, green: 255, blue: 255)
    @Published var fontSize: Int = 24
    @Published var fontDesign: SettingsFontDesign = .default
    @Published var fontWeight: SettingsFontWeight = .regular

    // Username
    @Published var usernameStyle: NostrChatUsernameStyle = .coloredFromPubkey
    @Published var usernameColor: RgbColor = .init(red: 100, green: 200, blue: 255)
    @Published var usernameFontWeight: SettingsFontWeight = .bold
    @Published var showColon: Bool = true

    // Zaps
    @Published var showZaps: Bool = true
    @Published var zapColor: RgbColor = .init(red: 255, green: 215, blue: 0)
    @Published var showZapAmount: Bool = true
    @Published var showZapMessage: Bool = true

    // Layout
    @Published var maxMessages: Int = 30
    @Published var messageSpacing: Float = 4
    @Published var messagePadding: Float = 6
    @Published var perMessageBackground: Bool = false
    @Published var perMessageBackgroundColor: RgbColor = .init(red: 0, green: 0, blue: 0, opacity: 0.5)
    @Published var perMessageCornerRadius: Float = 6

    // Behavior
    @Published var scrollDirection: NostrChatScrollDirection = .bottomToTop
    @Published var showTimestamps: Bool = false
    @Published var timestampColor: RgbColor = .init(red: 180, green: 180, blue: 180)

    // Text shadow (for readability on transparent bg)
    @Published var textShadow: Bool = true
    @Published var textShadowColor: RgbColor = .init(red: 0, green: 0, blue: 0, opacity: 0.8)
    @Published var textShadowRadius: Float = 2

    init() {}

    enum CodingKeys: CodingKey {
        case backgroundColor, cornerRadius,
             messageColor, fontSize, fontDesign, fontWeight,
             usernameStyle, usernameColor, usernameFontWeight, showColon,
             showZaps, zapColor, showZapAmount, showZapMessage,
             maxMessages, messageSpacing, messagePadding,
             perMessageBackground, perMessageBackgroundColor, perMessageCornerRadius,
             scrollDirection, showTimestamps, timestampColor,
             textShadow, textShadowColor, textShadowRadius
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.fontDesign, fontDesign)
        try container.encode(.fontWeight, fontWeight)
        try container.encode(.usernameStyle, usernameStyle)
        try container.encode(.usernameColor, usernameColor)
        try container.encode(.usernameFontWeight, usernameFontWeight)
        try container.encode(.showColon, showColon)
        try container.encode(.showZaps, showZaps)
        try container.encode(.zapColor, zapColor)
        try container.encode(.showZapAmount, showZapAmount)
        try container.encode(.showZapMessage, showZapMessage)
        try container.encode(.maxMessages, maxMessages)
        try container.encode(.messageSpacing, messageSpacing)
        try container.encode(.messagePadding, messagePadding)
        try container.encode(.perMessageBackground, perMessageBackground)
        try container.encode(.perMessageBackgroundColor, perMessageBackgroundColor)
        try container.encode(.perMessageCornerRadius, perMessageCornerRadius)
        try container.encode(.scrollDirection, scrollDirection)
        try container.encode(.showTimestamps, showTimestamps)
        try container.encode(.timestampColor, timestampColor)
        try container.encode(.textShadow, textShadow)
        try container.encode(.textShadowColor, textShadowColor)
        try container.encode(.textShadowRadius, textShadowRadius)
    }

    required init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        backgroundColor = container.decode(.backgroundColor, RgbColor.self, .init(red: 0, green: 0, blue: 0, opacity: 0.0))
        cornerRadius = container.decode(.cornerRadius, Float.self, 8)
        messageColor = container.decode(.messageColor, RgbColor.self, .init(red: 255, green: 255, blue: 255))
        fontSize = container.decode(.fontSize, Int.self, 24)
        fontDesign = container.decode(.fontDesign, SettingsFontDesign.self, .default)
        fontWeight = container.decode(.fontWeight, SettingsFontWeight.self, .regular)
        usernameStyle = container.decode(.usernameStyle, NostrChatUsernameStyle.self, .coloredFromPubkey)
        usernameColor = container.decode(.usernameColor, RgbColor.self, .init(red: 100, green: 200, blue: 255))
        usernameFontWeight = container.decode(.usernameFontWeight, SettingsFontWeight.self, .bold)
        showColon = container.decode(.showColon, Bool.self, true)
        showZaps = container.decode(.showZaps, Bool.self, true)
        zapColor = container.decode(.zapColor, RgbColor.self, .init(red: 255, green: 215, blue: 0))
        showZapAmount = container.decode(.showZapAmount, Bool.self, true)
        showZapMessage = container.decode(.showZapMessage, Bool.self, true)
        maxMessages = container.decode(.maxMessages, Int.self, 30)
        messageSpacing = container.decode(.messageSpacing, Float.self, 4)
        messagePadding = container.decode(.messagePadding, Float.self, 6)
        perMessageBackground = container.decode(.perMessageBackground, Bool.self, false)
        perMessageBackgroundColor = container.decode(.perMessageBackgroundColor, RgbColor.self, .init(red: 0, green: 0, blue: 0, opacity: 0.5))
        perMessageCornerRadius = container.decode(.perMessageCornerRadius, Float.self, 6)
        scrollDirection = container.decode(.scrollDirection, NostrChatScrollDirection.self, .bottomToTop)
        showTimestamps = container.decode(.showTimestamps, Bool.self, false)
        timestampColor = container.decode(.timestampColor, RgbColor.self, .init(red: 180, green: 180, blue: 180))
        textShadow = container.decode(.textShadow, Bool.self, true)
        textShadowColor = container.decode(.textShadowColor, RgbColor.self, .init(red: 0, green: 0, blue: 0, opacity: 0.8))
        textShadowRadius = container.decode(.textShadowRadius, Float.self, 2)
    }
}
...
class SettingsWidget: Codable, Identifiable, Equatable, ObservableObject, Named {
    ...
    var nostrChat: SettingsWidgetNostrChat = .init()
    @Published var enabled: Bool = true
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.nostrChat, nostrChat)
        try container.encode(.enabled, enabled)
    ...
    required init(from decoder: Decoder) throws {
        ...
        nostrChat = container.decode(.nostrChat, SettingsWidgetNostrChat.self, .init())
        enabled = container.decode(.enabled, Bool.self, true)
...
class SettingsRtmpServerStream: Codable, Identifiable, ObservableObject, Named {
    ...
    var id: UUID = .init()
    @Published var name: String = baseName
    @Published var streamKey: String = String(UUID().uuidString.prefix(8)).lowercased()
...
// MARK: - GoPro BLE Device Settings

enum SettingsGoProDeviceResolution: String, CaseIterable, Codable {
    case r1080p = "1080p"
    case r720p = "720p"
    case r480p = "480p"

    init(from decoder: Decoder) throws {
        self = try SettingsGoProDeviceResolution(
            rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .r1080p
    }
}

var goProDeviceBitrates: [UInt32] = [
    8_000_000,
    6_000_000,
    4_000_000,
    2_000_000,
...
class SettingsGoProDevice: Codable, Identifiable, ObservableObject, Named {
    ...
    @Published var serverRtmpUrl: String = ""
    @Published var customRtmpUrl: String = ""
    @Published var resolution: SettingsGoProDeviceResolution = .r1080p
    @Published var bitrate: UInt32 = 6_000_000
    @Published var autoRestartStream: Bool = true
    @Published var isStarted: Bool = false
    ...
    enum CodingKeys: CodingKey {
        case id, name, bluetoothPeripheralName, bluetoothPeripheralId,
             wifiSsid, wifiPassword, rtmpUrlType, serverRtmpStreamId,
             serverRtmpUrl, customRtmpUrl, resolution, bitrate,
             autoRestartStream, isStarted
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        serverRtmpUrl = container.decode(.serverRtmpUrl, String.self, "")
        customRtmpUrl = container.decode(.customRtmpUrl, String.self, "")
        resolution = container.decode(.resolution, SettingsGoProDeviceResolution.self, .r1080p)
        bitrate = container.decode(.bitrate, UInt32.self, 6_000_000)
        autoRestartStream = container.decode(.autoRestartStream, Bool.self, true)
        isStarted = container.decode(.isStarted, Bool.self, false)
    }

    func canStartLive() -> Bool {
        guard bluetoothPeripheralId != nil else { return false }
        guard !wifiSsid.isEmpty else { return false }
        switch rtmpUrlType {
        case .server:
...
class SettingsGoProDevices: Codable, ObservableObject {
...
class Database: Codable, ObservableObject {
    ...
    var goProDevices: SettingsGoProDevices = .init()
    ...
    @Published var skipPreStreamReview: Bool = false
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.goProDevices, goProDevices)
        try container.encode(.replay, replay)
        ...
        try container.encode(.skipPreStreamReview, skipPreStreamReview)
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        goProDevices = container.decode(.goProDevices, SettingsGoProDevices.self, .init())
        ...
        skipPreStreamReview = container.decode(.skipPreStreamReview, Bool.self, false)
    }
}

private func addDefaultScenes(database: Database) {
    var scene = SettingsScene(name: String(localized: "Main"))
    scene.cameraPosition = getDefaultBackCameraPosition()
    scene.backCameraId = getBestBackCameraId()
    database.scenes.append(scene)

    scene = SettingsScene(name: String(localized: "Selfie"))
    scene.cameraPosition = .front
    scene.frontCameraId = getBestFrontCameraId()
    database.scenes.append(scene)

    scene = SettingsScene(name: String(localized: "Dual"))
    scene.cameraPosition = getDefaultBackCameraPosition()
    scene.backCameraId = getBestBackCameraId()
    let frontCamWidget = SettingsWidget(name: String(localized: "Front Camera"))
    frontCamWidget.type = .videoSource
    frontCamWidget.videoSource.cameraPosition = .front
    frontCamWidget.videoSource.frontCameraId = getBestFrontCameraId()
    frontCamWidget.videoSource.cornerRadius = 12
    database.widgets.append(frontCamWidget)
    let sceneWidget = SettingsSceneWidget(widgetId: frontCamWidget.id)
    sceneWidget.x = 65.0
    sceneWidget.xString = "65.0"
    sceneWidget.y = 65.0
    sceneWidget.yString = "65.0"
    sceneWidget.width = 30.0
    sceneWidget.widthString = "30.0"
    sceneWidget.height = 30.0
    sceneWidget.heightString = "30.0"
    scene.widgets.append(sceneWidget)
    database.scenes.append(scene)

    scene = SettingsScene(name: String(localized: "Wide"))
    scene.cameraPosition = getDefaultBackCameraPosition()
    scene.backCameraId = getBestBackCameraId()
    database.scenes.append(scene)
}
...
private func addMissingQuickButtons(database: Database) {
    ...
    button = SettingsQuickButton(name: String(localized: "Zap Plasma"))
    button.id = UUID()
    button.type = .zapPlasma
    button.imageType = "System name"
    button.systemImageNameOn = "bolt.fill"
    button.systemImageNameOff = "bolt"
    button.enabled = false
    updateQuickButton(database: database, button: button)
...
final class Settings {
    ...
    private func addSensitiveData(database: Database) {
        ...
        // Load Tesla private key from Keychain into memory
        if let teslaKey = TeslaKeyStorage.shared.load() {
            database.tesla.privateKey = teslaKey
        }
    }
    ...
    private func extractSensitiveData(fromDatabase: Database) -> Database {
        ...
        // Save Tesla private key to Keychain and strip from serialization
        toDatabase.tesla.privateKey = fromDatabase.tesla.privateKey
        if !fromDatabase.tesla.privateKey.isEmpty {
            TeslaKeyStorage.shared.store(privateKeyPem: fromDatabase.tesla.privateKey)
        }
        fromDatabase.tesla.privateKey = ""
        return toDatabase
    }
    ...
    private func insertSensitiveData(toDatabase: Database, fromDatabase: Database) {
        ...
        // Restore Tesla private key into memory after serialization
        toDatabase.tesla.privateKey = fromDatabase.tesla.privateKey
    }

...
final class BrowserEffect: VideoEffect {
    ...
    /// Updates position without restarting the snapshot timer.
    /// Used during drag-to-position to avoid timer thrashing at 60fps.
    func updatePositionOnly(pixelX: Double, pixelY: Double) {
        self.x = pixelX
        self.y = pixelY
    }

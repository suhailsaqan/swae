...
/// Content-only wrapper for UIKit hosting. Same as RightOverlayTopView but without
/// the Spacer(). Includes AudioView + StatusesView + onTapGesture.
struct RightTopStatusContentView: View {
    let model: Model
    @ObservedObject var database: Database

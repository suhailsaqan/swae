...
struct MainView: View {
    ...
    private func portrait() -> some View {
        GeometryReader { geometry in
            ...
            let cameraAreaHeight = geometry.size.height - controlsHeight + geometry.safeAreaInsets.top
            ...
            ZStack(alignment: .bottom) {
                ...
                VStack(spacing: 0) {
                    // Camera preview area - from top of screen to controls
                    ZStack {
                        // Camera preview centered in available space, maintaining aspect ratio
                    ...
                    LiquidGlassControlPanelWrapper()
                        .frame(height: controlsHeight + safeAreaBottom)
                }
            }
            .ignoresSafeArea()
        }

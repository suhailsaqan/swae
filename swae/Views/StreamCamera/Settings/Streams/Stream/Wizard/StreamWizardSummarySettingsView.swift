    ...
    var body: some View {
        ...
        case .twitch:
            Section {
                ...
                TextValueView(
                    name: String(localized: "Channel id"), value: createStreamWizard.twitchChannelId
                )
            } header: {
                Text("Twitch")
            }
        ...
        case .afreecaTv:
            Section {
                ...
                TextValueView(
                    name: String(localized: "Video id"), value: createStreamWizard.afreecaTvStreamId
                )
            } header: {
                Text("AfreecaTV")
            }
        ...
        case .zapStreamCore:
            Section {
                TextValueView(
                    ...
                    value: createStreamWizard.zapStreamCoreStreamTitle
                )
                TextValueView(
                    name: String(localized: "Stream description"),
                    value: createStreamWizard.zapStreamCoreStreamDescription
                )
                TextValueView(
                    name: String(localized: "Public stream"),
                    value: createStreamWizard.zapStreamCoreIsPublic ? "Yes" : "No"
                )
                TextValueView(
                    name: String(localized: "Streaming URL"),
...
private struct NetworkSetupDirectView: View {
    ...
    var body: some View {
        ...
        case .kick:
            TextValueView(
                name: String(localized: "Stream URL"), value: createStreamWizard.directIngest)
            TextValueView(
                name: String(localized: "Stream key"),
                value: createStreamWizard.directStreamKey
            )
...
private struct NetworkSetupView: View {
    ...
    var body: some View {
        if createStreamWizard.networkSetup == .obs {
            ...
            Section {
                TextValueView(
                    name: String(localized: "Ingest URL"), value: createStreamWizard.belaboxUrl)
            } header: {
                Text("BELABOX cloud")
            }
        ...
        Form {
                ...
                || createStreamWizard.networkSetup == .myServers
            {
                if createStreamWizard.customProtocol == .srt {
                    Section {
                        TextValueView(
                            name: String(localized: "URL"), value: createStreamWizard.customSrtUrl)
                        TextValueView(
                    ...
                    Section {
                        TextValueView(
                            name: String(localized: "URL"), value: createStreamWizard.customRtmpUrl)
                        TextValueView(
                            name: String(localized: "Stream key"),
